...
import com.ashwin.android.notespace.common.awaitTaskResult
import com.ashwin.android.notespace.common.toNote
import com.ashwin.android.notespace.common.toUser
import com.ashwin.android.notespace.model.Note
import com.ashwin.android.notespace.model.NoteDao
...
import com.ashwin.android.notespace.model.FirebaseNote
...
class NoteRepoImpl(
    ...
    override suspend fun deleteNote(note: Note): Result<Exception, Unit> {
        val user = getActiveUser()
        return if (user != null) {
            deleteRemoteNote(note.copy(creator = user))
        } else {
    ...
    override suspend fun updateNote(note: Note): Result<Exception, Unit> {
        val user = getActiveUser()
        return if (user != null) {
            updateRemoteNote(note.copy(creator = user))
        } else {
